...
#### Usage
I've updated everything so now it's available cross-platform through the github release. Getting it to run on MacOS is a bit difficult, but it works. On MacOS and Linux, you'll need to:
`
### Python 
